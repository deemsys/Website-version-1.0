...
Refinery::Pages.configure do |config|
  ...
  config.layout_template_whitelist = ["application","Master","Layout_2_1","contact","Partnership","services","platform","platform_main","transact_main","analytic_main","world","collabrate_main","engage_main"]
